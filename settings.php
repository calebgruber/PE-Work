      ...
      <form method="post">
        ...
        <div class="card-grid">
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="equipment_min_rows_per_page" type="number" min="0" max="100" step="1" name="equipment_min_rows_per_page" value="<?= h($layout['layout.equipment_min_rows_per_page'] ?? '0') ?>">
