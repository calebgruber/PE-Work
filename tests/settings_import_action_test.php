...
settings_assert(str_contains($layoutPageHtml, 'If the next row would get cut off, it moves to the next page.'), 'Expected layout settings page to explain that overflow rows move to the next page.', $repoRoot, $localConfig, $localBackup, $movedLocalConfig, $process, $pipes, $testPaths);
