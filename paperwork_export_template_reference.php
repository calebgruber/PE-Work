...
/**
 * Portable paperwork export template reference.
 *
 * Copy this file together with paperwork_export_settings_reference.php into another
 * PHP project when you want the export output to match this repository exactly.
 *
 * At runtime this file exposes $paperworkExportSettingsReference first, so another
 * agent/project can inspect the full configurable option catalog before using the
 * export pipeline below.
 *
 * Notes for another project:
 * - configurable settings live in $paperworkExportSettingsReference['configurable_options']
 * - current values live in $paperworkExportSettingsReference['current_export_settings']
 * - show-level overrides are listed in $paperworkExportSettingsReference['show_override_keys']
 * - the remainder of this file is the current export.php body copied from this repo
 */

$paperworkExportSettingsReference = file_exists(__DIR__ . '/paperwork_export_settings_reference.php')
